...
const ThemeButton = styled.button`width:34px;height:34px;display:grid;place-items:center;justify-self:end;border:0;border-radius:4px;color:var(--color-text-secondary);background:transparent;cursor:pointer;&:hover{color:var(--color-text-primary);background:var(--color-surface-muted);}`;
