...
const VerificationReceipt = styled.aside`position:relative;width:100%;padding:31px 31px 27px;background:var(--color-surface);border:1px solid var(--color-border);box-shadow:0 18px 44px var(--color-shadow);animation:${heroEntrance} 900ms 760ms cubic-bezier(.22,1,.36,1) both;@media(max-width:920px){width:min(100%,500px);}@media(max-width:520px){padding:25px 23px 22px;}@media(prefers-reduced-motion:reduce){animation:none;}`;
