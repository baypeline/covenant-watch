...
const Nav = styled.nav`height:74px;border-bottom:1px solid var(--line);display:flex;align-items:center;justify-content:space-between;padding:0 max(24px,calc((100vw - 1180px)/2));position:relative;z-index:1;background:var(--color-nav);`;
const Brand = styled.div`display:flex;align-items:center;gap:11px;font-size:16px;font-weight:700;letter-spacing:-.02em;`;
const BrandMark = styled.span`width:34px;height:34px;display:grid;place-items:center;border:1px solid var(--color-action-border);border-radius:10px;color:var(--proof);background:var(--color-action-subtle);`;
...
const SwitchButton = styled.button<{ $active:boolean }>`border:1px solid ${p=>p.$active?'var(--color-action-border)':'transparent'};border-radius:8px;padding:8px 15px;display:flex;align-items:center;gap:8px;cursor:pointer;background:${p=>p.$active?'var(--color-action-subtle)':'transparent'};color:${p=>p.$active?'var(--text-primary)':'var(--text-secondary)'};font-weight:600;font-size:13px;transition:background .18s,border-color .18s,color .18s;&:hover{color:var(--text-primary);}`;
const ProofRail = styled.section`display:grid;grid-template-columns:auto 1fr auto 1fr auto;align-items:center;margin:0 0 18px;padding:15px 18px;border:1px solid var(--line);border-radius:14px;background:var(--surface-muted);@media(max-width:680px){grid-template-columns:1fr;gap:10px;}`;
...
const RailIcon = styled.div`grid-row:1/3;width:30px;height:30px;display:grid;place-items:center;border:1px solid var(--color-action-border);border-radius:50%;color:var(--proof);background:var(--canvas);`;
const RailLink = styled.span<{ $active:boolean }>`height:1px;margin:0 15px;background:${p=>p.$active?'var(--proof)':'var(--line)'};@media(max-width:680px){width:1px;height:12px;margin:0 0 0 14px;}`;
...
const PrimaryCard = styled.section`border:1px solid var(--line);background:var(--surface);border-radius:20px;padding:28px;box-shadow:0 18px 48px var(--color-shadow);`;
...
const RoundBadge = styled.div`padding:8px 12px;border:1px solid var(--color-action-border);border-radius:9px;color:var(--proof);background:var(--color-action-subtle);font-size:13px;font-weight:700;`;
...
const PrivacyNote = styled.div`display:flex;gap:11px;align-items:flex-start;margin-top:16px;padding:14px;border:1px solid var(--line);border-radius:11px;background:var(--surface-muted);color:var(--text-primary);svg{flex:0 0 auto;color:var(--text-secondary);}div{display:flex;flex-direction:column;gap:4px;}strong{font-size:12px;}span{font-size:11px;color:var(--text-secondary);line-height:1.55;}`;
const ActionRow = styled.div`display:flex;gap:9px;margin-top:20px;@media(max-width:520px){flex-direction:column;}`;
const PrimaryButton = styled.button`border:0;border-radius:10px;background:var(--proof);color:var(--color-on-action);height:46px;padding:0 18px;display:flex;align-items:center;justify-content:center;gap:9px;font-size:13px;font-weight:760;cursor:pointer;transition:background .18s,color .18s;&:hover:not(:disabled){background:var(--proof-hover);}&:disabled{opacity:.55;cursor:not-allowed;}`;
...
const ResultBox = styled.div<{ $success:boolean }>`display:flex;gap:10px;margin-top:16px;border:1px solid ${p=>p.$success?'var(--color-success-border)':'var(--color-danger-border)'};background:${p=>p.$success?'var(--color-success-bg)':'var(--color-danger-bg)'};color:${p=>p.$success?'var(--success)':'var(--danger)'};padding:14px;border-radius:11px;svg{flex:0 0 auto;}div{display:flex;flex-direction:column;gap:3px;}strong{font-size:13px;}span{font-size:11px;color:var(--text-secondary);line-height:1.55;}`;
const ConnectionNotice = styled(ResultBox)`border-color:var(--color-warning-border);background:var(--color-warning-bg);color:var(--warning);`;
const EvidenceBox = styled.div`margin-top:10px;padding:14px;border:1px solid var(--color-action-border);border-radius:11px;background:var(--canvas);`;
...
const ApprovalVisual = styled.div<{ $approved:boolean }>`min-height:184px;border:1px solid ${p=>p.$approved?'var(--color-success-border)':'var(--line)'};border-radius:15px;background:${p=>p.$approved?'var(--color-success-bg)':'var(--surface-muted)'};display:flex;align-items:center;gap:20px;padding:26px;`;
const ApprovalIcon = styled.div<{ $approved:boolean }>`width:58px;height:58px;flex:0 0 auto;display:grid;place-items:center;border-radius:50%;color:${p=>p.$approved?'var(--success)':'var(--text-secondary)'};background:${p=>p.$approved?'var(--color-success-bg)':'transparent'};border:1px solid currentColor;`;
...
const StateTag = styled.b<{ $approved:boolean }>`font-size:10px!important;letter-spacing:.07em;color:${p=>p.$approved?'var(--success)':'var(--text-secondary)'};background:${p=>p.$approved?'var(--color-success-bg)':'var(--color-neutral-subtle)'};padding:5px 7px;border-radius:6px;`;
...
const PolicyIcon = styled.div`width:38px;height:38px;display:grid;place-items:center;color:var(--proof);border:1px solid var(--color-action-border);border-radius:10px;float:right;`;
